      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
            ...
            <li class="message-item">
              <a href="#">
                <img src="../../images/img/messages-1.jpg" alt="" class="rounded-circle">
                <div>
                  <h4>Maria Hudson</h4>
            ...
            <li class="message-item">
              <a href="#">
                <img src="../../images/img/messages-2.jpg" alt="" class="rounded-circle">
                <div>
                  <h4>Anna Nelson</h4>
                  <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                  <p>6 hrs. ago</p>
            ...
            <li class="message-item">
              <a href="#">
                <img src="../../images/img/messages-3.jpg" alt="" class="rounded-circle">
                <div>
                  <h4>David Muldon</h4>
                  <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                  <p>8 hrs. ago</p>
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="../../images/img/profile-img.jpg" alt="Profile" class="rounded-circle">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse show " data-bs-parent="#sidebar-nav">
          <li>
            <router-link to="/dashboard/addstudent" class="active">
...
<div class="pagetitlev2">
  <h1>Add students</h1>
</div>  
    <div class="bodyyy">
 <form class="form">
    <span class="signup">Add Student</span>
    <input type="Matricule" placeholder="Matricule" class="form--input">
    <input type="text" placeholder="Nom " class="form--input">
    <textarea  placeholder="description" class="form--input"></textarea>
  <button type="button" class="form--submit" data-toggle="modal" data-target="#myModal">
Add Instructor
  </button>
...
export default {
  ...
  <style src="../../../css/adminDash/addvehicle.css"></style>
