...
<div class="pagetitlev2">
  <h1>Vehicle List</h1>
    ...
    <div class="bodyyy">
 <form class="form">
    <span class="signup">Add Vehicle</span>
    <input type="text" placeholder="Matricule" required v-model="matricule" class="form--input">
    <input type="text" placeholder="Nom " required v-model="nom" class="form--input">

    <div class="selectdiv">
  <label>
    <select v-model="moniteurId">
    ...
    <div class="radio-inputs">
		<label>
			<input class="radio-input" type="radio" name="engine" value="track" v-model="type" >
  ...
  <path d="M0 3.5A1.5 1.5 0 0 1 1.5 2h9A1.5 1.5 0 0 1 12 3.5V5h1.02a1.5 1.5 0 0 1 1.17.563l1.481 1.85a1.5 1.5 0 0 1 .329.938V10.5a1.5 1.5 0 0 1-1.5 1.5H14a2 2 0 1 1-4 0H5a2 2 0 1 1-3.998-.085A1.5 1.5 0 0 1 0 10.5zm1.294 7.456A2 2 0 0 1 4.732 11h5.536a2 2 0 0 1 .732-.732V3.5a.5.5 0 0 0-.5-.5h-9a.5.5 0 0 0-.5.5v7a.5.5 0 0 0 .294.456M12 10a2 2 0 0 1 1.732 1h.768a.5.5 0 0 0 .5-.5V8.35a.5.5 0 0 0-.11-.312l-1.48-1.85A.5.5 0 0 0 13.02 6H12zm-9 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2m9 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2"/>
		...
		<label>
			<input checked class="radio-input" type="radio" name="engine" value="motor" v-model="type">
			<span class="radio-tile">
				<span class="radio-icon">
		...
		<label>
			<input class="radio-input" type="radio" name="engine" value="car" v-model="type">
			<span class="radio-tile">
				<span class="radio-icon">
  ...
  <br>
    <button class="form--submit"  @click="AddVechule">
        ADD + 
    </button>
</form>
</div>
...
<script src="./services/addvechule.js"></script>
