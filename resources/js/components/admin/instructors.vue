  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Auto Ecole</span>
      </a>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
          <li>
            <router-link to="/dashboard/addstudent">
              <i class="bi bi-plus"></i><span>Add students</span>
            </router-link>
          </li>
          <li>
            <router-link to="/dashboard/students">
              <i class="bi bi-check"></i><span>Students List</span>
            </router-link>
          </li>
      ...
      <li class="nav-item">
        <a class="nav-link " data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-person-badge"></i><span>Instructors</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <router-link to="/dashboard/addinstructors">
             <i class="bi bi-plus"></i><span>Add Instructors</span>
            </router-link>          
        </li>
          <li>
            <router-link to="/dashboard/instructors" class="active">
              <i class="bi bi-check"></i><span>Instructor List</span>
            </router-link>
          </li>
        </ul>
      </li><!-- End Forms Nav -->
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
          <i class='bx bx-credit-card-front'></i><span>Exams</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="tables-general.html">
              <i class="bi bi-plus"></i><span>Add Exam</span>
            </a>
          </li>
          <li>
            <a href="tables-data.html">
              <i class="bi bi-check"></i><span>All Exams</span>
            </a>
          </li>
        </ul>
      </li>
      <li class="nav-item ">
        <a class="nav-link collapsed" data-bs-target="#vechule-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-car-front"></i><span>vehicle</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="vechule-nav" class="nav-content collapse  " data-bs-parent="#sidebar-nav">
          <li>
            <router-link to="/dashboard/addvehicle" >
              <i class="bx bx-plus" ></i><span>Add vehicle</span>
            </router-link>
          </li>
          <li>
            <router-link to="/dashboard/vehicle" >
              <i class="bi bi-check"></i><span>vehicle List</span>
            </router-link>
          </li>
        </ul>
      </li>
...
<div class="pagetitlev3">
  ...
  <br>
    <section class="section dashboard">
      <div v-for="moniteur in moniteurs" :key="moniteur.id">

    <div class="custom-ancard">
  <button class="custom-mail" @click="deleteMoniteur(moniteur.user.id)">
    <svg
    @click="deleteMoniteur(moniteur.user.id)"
      class="custom-lucide custom-lucide-mail"    
...
<div v-else-if="vehicle.type == 'track'">

                           <svg @click="openVehicleModal(vehicle)"  xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-truck" viewBox="0 0 16 16">
                    <path d="M0 3.5A1.5 1.5 0 0 1 1.5 2h9A1.5 1.5 0 0 1 12 3.5V5h1.02a1.5 1.5 0 0 1 1.17.563l1.481 1.85a1.5 1.5 0 0 1 .329.938V10.5a1.5 1.5 0 0 1-1.5 1.5H14a2 2 0 1 1-4 0H5a2 2 0 1 1-3.998-.085A1.5 1.5 0 0 1 0 10.5zm1.294 7.456A2 2 0 0 1 4.732 11h5.536a2 2 0 0 1 .732-.732V3.5a.5.5 0 0 0-.5-.5h-9a.5.5 0 0 0-.5.5v7a.5.5 0 0 0 .294.456M12 10a2 2 0 0 1 1.732 1h.768a.5.5 0 0 0 .5-.5V8.35a.5.5 0 0 0-.11-.312l-1.48-1.85A.5.5 0 0 0 13.02 6H12zm-9 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2m9 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2"/>
                        </svg>
                        </div>
                        </div>
      </div>
      <button class="custom-button">UPDATE INFO</button>
    </div>
  </div>
</div>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body p-0 row" v-if="selectedVehicle">
                  
                    <div class="col-12 col-lg-5 ad p-0"> <img :src=selectedVehicle.image width="50%" height="50%"/> </div>
                    <div class="details col-12 col-lg-7"  >
                        <h2> {{ selectedVehicle.type }} Details</h2>
                        <p><small class="para">{{ selectedVehicle.nom }}<br> {{ selectedVehicle.matricule }}.</small></p>
                        
<div class="codepen-wrapper">
  <span class="registration-ui">{{ selectedVehicle.matricule }}</span>
</div>
    
                                  <br>
                        <small class="text-muted"><a href="#">Change vechule</a></small>
                    </div>
                </div>
            </div>
        </div>
...
<style src="../../../css/adminDash/instructors.css"></style>
 ...
 */
 ...
 .codepen-wrapper {
    ...
    border: 2px solid #2b2a2f; /* Border color for the license plate */
    padding: 5px 10px; /* Adjust padding as needed */
    background-color: #2b2a2f; /* Background color for the license plate */
    font-size: 16px; /* Adjust font size as needed */
    font-weight: bold;
    color: #fff; /* Text color for the license plate */
    letter-spacing: 2px; /* Adjust letter spacing as needed */
    border-radius: 5px; /* Adjust border radius as needed */
    font-family: 'Amiri', serif; /* Specify the Lateef font */
