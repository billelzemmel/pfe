<template>
     ...
     <ul class="sidebar-nav" id="sidebar-nav">
       ...
       <li class="nav-item">
         ...
         <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
           ...
           <li>
            <router-link to="/dashboard/students"  class="active">
       ...
       <li class="nav-item">
         ...
         <ul id="forms-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
           ...
           <li>
             <router-link to="/dashboard/instructors" >
 ...
 <div class="pagetitlev3">
   ...
   <br>
     ...
     <div class="custom-ancards">
   <button class="custom-mails">
     <svg
       class="custom-lucides custom-lucide-mails"    
       xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"  viewBox="0 0 16 16">
     
     <path d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5M11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H1.5a.5.5 0 0 0 0 1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1-.997-.92L3.042 3.5zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 .528-.47M8 4.5a.5.5 0 0 1 .5.5v8.5a.5.5 0 0 1-1 0V5a.5.5 0 0 1 .5-.5"/>
     </svg>
   </button>
   <div class="custom-profile-pics">
     <img class="imggg" src="../../../images/person images.jpg" />
   </div>
   <div class="custom-bottoms">
     <div class="custom-contents">
       <span class="custom-names">My Name</span>
       <span class="custom-about-mes"
         >Lorem ipsum dolor sit amet consectetur adipisicinFcls
       </span>
     </div>
     <div class="custom-bottom-bottoms">
       <div class="custom-social-links-containers">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-square" viewBox="0 0 16 16" data-toggle="modal" data-target="#exampleModal">
  <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0"/>
  <path d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2zm12 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1v-1c0-1-1-4-6-4s-6 3-6 4v1a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1z"/>
</svg>
       </div>
       <button class="custom-buttons">UPDATE INFO</button>
     </div>
   </div>
 </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Instructor Informations</h5>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
                                  <div class="d-flex flex-column">
                                    ...
                                    <span class="heading d-block">vechule</span>
                            ...
                            <tr>
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <span class="subheadings">  <div class="openbtn text-center">
...
<div class="modal fade" id="myModal">
    ...
    <div class="modal-content">
      <div class="modal-header">
		<h4 class="modal-title">What are your Interest? </h4>
         <button type="button" class="closess" data-dismiss="modal">×</button>
 ...
 export default {
   ...
   methods: {
     toggleSidebar() {
       ...
       // If sidebar is open, add 'collapse' class; otherwise, remove it
 ...
 <style scoped src="../../../css/adminDash/student.css"></style>
