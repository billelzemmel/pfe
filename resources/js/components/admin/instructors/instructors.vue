...
<div class="pagetitlev3">
  ...
  <div class="custom-bottom">
    <div class="custom-content">
      <span class="custom-name">{{moniteur.user.nom}} {{moniteur.user.prenom}}</span>
    ...
    <div class="custom-bottom-bottom">
      <div class="custom-social-links-container">
        <div v-for="vehicle in moniteur.vehicles" :key="vehicle.id" class="card-wrapper">
...
<div v-else-if="vehicle.type == 'track'">
    ...
    <div class="instructorModal modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script src="./services/instructors.js"></script>
<style scoped src="./css/instructors.css"></style>
