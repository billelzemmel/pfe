...
Route::middleware(['auth:sanctum'])->group(function () {
    Route::middleware('permission_auth')->group(function () {
        ...
        Route::get('/CountExamsCode/{id}', [ExamController::class, 'CountExamsCode']);
        Route::get('/CountExamsConduit/{id}', [ExamController::class, 'CountExamsConduit']);
        
        
        
        
        Route::get('/CountMoniteurId/{id}', [CandidatsController::class, 'CountMoniteurId']);
    });
});
